        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6 lg:py-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4 lg:space-x-6 w-full sm:w-auto">
              <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-xl sm:rounded-2xl overflow-hidden flex items-center justify-center shadow-modern-lg ring-2 sm:ring-4 ring-act-blue/20 flex-shrink-0">
                <img 
                  src="/ACTIEF-ERT.jpg" 
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-lg sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-1 leading-tight" data-testid="header-title">
                  Emergency Response Team
                </h1>
                <p className="text-xs sm:text-sm lg:text-base text-gray-600 dark:text-gray-400 mb-2 sm:mb-1 leading-tight">
                  Asian College of Technology - Main Campus
                </p>
                <p className="text-xs sm:text-sm text-act-blue font-semibold bg-act-blue/10 px-2 sm:px-3 py-1 rounded-full inline-block">
            ...
            <div className="w-full sm:w-auto text-left sm:text-right">
              <Button 
                ...
                variant="outline" 
                size="sm"
                className="bg-act-blue text-white border-act-blue hover:bg-blue-700 w-full sm:w-auto min-h-[44px] px-4 py-2"
            ...
            <Card className="modern-card border-l-4 border-l-emergency-red shadow-modern-xl hover:shadow-modern-2xl transition-all duration-200">
              ...
              <CardContent className="p-4 sm:p-6">
                ...
                <Button 
                  ...
                  className="w-full emergency-gradient text-white font-bold modern-button hover:scale-105 transform transition-all duration-200 min-h-[48px] text-sm sm:text-base"
            ...
            <Card className="modern-card border-l-4 border-l-act-yellow shadow-modern-lg hover:shadow-modern-xl transition-all duration-200">
              ...
              <CardContent className="p-4 sm:p-6">
                ...
                <Button 
                  ...
                  className="w-full warning-gradient text-white font-semibold modern-button hover:scale-105 transform transition-all duration-200 min-h-[48px] text-sm sm:text-base"
            ...
            <Card className="modern-card border-l-4 border-l-gray-400 shadow-modern-lg">
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm">
                  <div className="flex items-start space-x-2 sm:space-x-3 p-3 bg-gray-50/50 dark:bg-gray-800/50 rounded-xl">
